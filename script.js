...
function startMic() {
    ...
    recognition.onend   = function() { mic.textContent = "🎤"; mic.style.background = "#f97316"; mic.style.animation = ""; input.placeholder = "Search products..."; };
    recognition.onerror = function() { mic.textContent = "🎤"; mic.style.background = "#f97316"; mic.style.animation = ""; input.placeholder = "Search products..."; };
}
